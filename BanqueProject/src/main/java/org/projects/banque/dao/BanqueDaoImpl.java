...
public class BanqueDaoImpl implements IbanqueDao {
	...
	public List<Operation> consulterOperations(String codeCpte) {
		Query req = em
				.createQuery("select o from Operation o where o.compte.codeCompte=:x");
	...
	public List<Client> consulterClients(String mc) {
		Query req = em
				.createQuery("select c from Client c where c.nomClient like :x");
	...
	public List<Compte> getComptebyClients(Long codeCli) {
		Query req = em
				.createQuery("select c from Compte c where c.client.codeClient=:x");
	...
	public List<Client> getComptebyEmploye(Long codeEmp) {
		Query req = em
				.createQuery("select c from Compte c where c.employe.codeEmploye=:x");
	...
	public List<Employe> getEmployesByGroupe(Long codeGr) {
		...
		Query req = em
				.createQuery("select e from Employe e where e.groupe.codeGroupe=:x");
